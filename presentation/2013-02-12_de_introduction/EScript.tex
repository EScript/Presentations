...
\begin{frame}{Attribute}
	\todo[inline]{"`Attribut"' ist nicht das korrekte Wort}
	\begin{block}{Beispiel}
...
\begin{frame}{Fakultät}
	\todo[inline]{Rekursion (thisFn) vorher einführen}
	\todo[inline]{Typüberprüfung für Parameter vorher einführen}
